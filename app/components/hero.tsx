    ...
    <div className="grid md:grid-cols-3 lg:grid-cols-3 gap-6 items-center">
      <div className="w-full flex flex-col gap-4 items-center">
        <div className="flex flex-col md:fixed lg:fixed top-20 md:mt-5 lg:mt-5 md:pt-5 md:pt-5 items-center">
          ...
          <p className="flex items-center text-lg mt-2"><svg className="text-red-500 mr-1" stroke="currentColor" fill="none" strokeWidth="1.5" viewBox="0 0 24 24" aria-hidden="true" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" d="M12.75 3.03v.568c0 .334.148.65.405.864l1.068.89c.442.369.535 1.01.216 1.49l-.51.766a2.25 2.25 0 0 1-1.161.886l-.143.048a1.107 1.107 0 0 0-.57 1.664c.369.555.169 1.307-.427 1.605L9 13.125l.423 1.059a.956.956 0 0 1-1.652.928l-.679-.906a1.125 1.125 0 0 0-1.906.172L4.5 15.75l-.612.153M12.75 3.031a9 9 0 0 0-8.862 12.872M12.75 3.031a9 9 0 0 1 6.69 14.036m0 0-.177-.529A2.25 2.25 0 0 0 17.128 15H16.5l-.324-.324a1.453 1.453 0 0 0-2.328.377l-.036.073a1.586 1.586 0 0 1-.982.816l-.99.282c-.55.157-.894.702-.8 1.267l.073.438c.08.474.49.821.97.821.846 0 1.598.542 1.865 1.345l.215.643m5.276-3.67a9.012 9.012 0 0 1-5.276 3.67m0 0a9 9 0 0 1-10.275-4.835M15.75 9c0 .896-.393 1.7-1.016 2.25"></path></svg><span>Philippines</span></p>
          <p className="flex items-center text-lg mt-2"><svg className="text-red-500 mr-1" stroke="currentColor" fill="none" strokeWidth="1.5" viewBox="0 0 24 24" aria-hidden="true" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a1.5 1.5 0 0 0 1.5-1.5v-2.742a1.5 1.5 0 0 0-1.11-1.448l-2.91-.727a1.5 1.5 0 0 0-1.548.527l-.638.85a1.5 1.5 0 0 1-1.607.548 12.035 12.035 0 0 1-7.44-7.44 1.5 1.5 0 0 1 .548-1.607l.85-.638a1.5 1.5 0 0 0 .527-1.548L6.69 3.36A1.5 1.5 0 0 0 5.242 2.25H2.5A1.5 1.5 0 0 0 1 3.75v3z"/></svg><span>+639087894288</span></p>
          <div className="flex">
      ...
      <div className="flex-col col-span-2">
        ...
        <p className="text-lg mt-5">Full Stack Developer with experience building modern web applications using Node.js, Next.js, React, ReactNative, Nuxt.js, Vue, Supabase, Prisma, Tailwind CSS, Wordpress, Woocommerce, Laravel, CodeIgniter, PostgreSQL, MDBootstrap, Bootstrap, Git, AWS. Skilled in developing responsive frontends, scalable backend systems, REST APIs, authentication, and database management. Passionate about creating clean, efficient, and user-friendly applications with modern technologies.</p>
